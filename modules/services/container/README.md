...
| <a name="input_image_name"></a> [image\_name](#input\_image\_name) | Deepfence cloud scanner image. GCP only allows the deployment of images that are registered in gcr.io | `string` | `"us-east1-docker.pkg.dev/deepfenceio/deepfence/cloud_scanner_ce:2.5.1"` | no |
